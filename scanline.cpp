// scanline.cpp : Defines the entry point for the console application.
//
...
void display()
{
	x1=100.0,y1=100.0,x2=300.0,y2=100.0,x3=200.0,y3=300.0,x4=300.0,y4=300.0;
